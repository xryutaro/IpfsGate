 ...
 * This file demonstrates how to integrate Ipfsgate with a web frontend
 */

// For React/Vue/Angular applications
export class IpfsgateClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new IpfsgateClient(provider, contractAddress);
